<div class="listContainer">
    ...
    <div class="row">
        <form name="updateTask" id="updateTask" novalidate="" method="POST" action="{{action('ListController@update'),$todo['id']}}" {{ method_field('PUT') }}
        ...
        <div class="row">
            <form name="deleteTask" id="updateTask" novalidate="" method="POST" action="{{action('ListController@destroy'),$todo['id']}}" {{ method_field('DELETE') }}
            <div class="listText col-sm-4 todos-item">
                {{$todo['task']}}
            </div>
            <div class="listButton col-sm-4 todos-item">
